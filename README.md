## App Transport Security Plugin for Apache Cordova [![npm version](https://badge.fury.io/js/cordova-plugin-ipad-multitasking.svg)](http://badge.fury.io/js/cordova-plugin-ipad-multitasking)
